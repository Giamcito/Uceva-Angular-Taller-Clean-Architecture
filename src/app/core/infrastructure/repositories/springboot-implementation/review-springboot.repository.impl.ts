...
/**
 * Implementación concreta del repositorio de reseñas con backend SpringBoot.
 *
 * @remarks
 ...
 * - La fuente de datos remota SpringBoot {@link DataService}
 *
 * Responsabilidades:
 * - Implementar el contrato definido por el dominio
 * - Delegar la obtención de datos al datasource SpringBoot
 ...
 */
@Injectable()
export class ReviewSpringBootRepositoryImpl extends ReviewRepository {

    /**
     * Datasource encargado de obtener los datos de reseñas desde SpringBoot.
     *
     * @remarks
    ...
    /**
     * Obtiene el listado completo de reseñas desde el backend SpringBoot.
     *
     * @remarks
     ...
     *
     * @returns {Observable<Review[]>} Observable que emite el array de reseñas desde SpringBoot
     *
     * @example
     * ```ts
    ...
    override getAll(): Observable<Review[]> {
        return this.dataService.getAllReviewsSpringBoot(10);
    }
}
